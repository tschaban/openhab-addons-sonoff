# Sonoff Binding Fast Compile and Upload Script
# Compiles the Sonoff binding and deploys it to OpenHAB
# SKIPS UNIT TESTS for faster iteration during development

# Configuration
$projectPath = "D:\Adrian\Projekty\openhab\openhab-addons\bundles\org.openhab.binding.sonoff"
$jarSourcePath = "D:\Adrian\Projekty\openhab\openhab-addons\bundles\org.openhab.binding.sonoff\target\org.openhab.binding.sonoff-5.0.3-SNAPSHOT.jar"
$jarDestPath = "O:\configuration\addons\org.openhab.binding.sonoff-5.0.3-SmartnyDom-v0.x.jar"
...
Write-Host "  Sonoff Binding FAST Compile & Upload" -ForegroundColor Cyan
Write-Host "  ⚡ UNIT TESTS SKIPPED ⚡" -ForegroundColor Red
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "⚠️  WARNING: This is a FAST pipeline for development" -ForegroundColor Yellow
Write-Host "⚠️  Unit tests are SKIPPED for faster iteration" -ForegroundColor Yellow
Write-Host "⚠️  Use run-local-cicd-pipeline.ps1 for full validation" -ForegroundColor Yellow
Write-Host ""
...
# Step 4: SKIPPED - Unit tests
Write-Host "[STEP 4/6] Unit tests: SKIPPED ⚡" -ForegroundColor Magenta
Write-Host "⚠️  Tests are skipped for faster development iteration" -ForegroundColor Yellow
Write-Host "⚠️  Run full pipeline before committing changes" -ForegroundColor Yellow
Write-Host ""

# Step 5: Clean and compile the binding
Write-Host "[STEP 5/6] Compiling Sonoff binding..." -ForegroundColor Yellow
...
Write-Host "[STEP 6/6] Deploying JAR to OpenHAB..." -ForegroundColor Yellow
...
# Optional: Clear OpenHAB log
Write-Host "[OPTIONAL] Clearing OpenHAB log file..." -ForegroundColor Yellow
Write-Host "Log file: $logPath" -ForegroundColor Gray
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "[SUCCESS] Sonoff binding FAST deployment completed!" -ForegroundColor Green
Write-Host ""
...
Write-Host "  - This is a FAST pipeline for development iteration" -ForegroundColor White
Write-Host "  - Unit tests were SKIPPED to save time" -ForegroundColor White
Write-Host "  - Run full pipeline (run-local-cicd-pipeline.ps1) before:" -ForegroundColor White
...
Write-Host "  3. Test your changes with actual devices" -ForegroundColor White
Write-Host "  4. Run full pipeline when ready to commit" -ForegroundColor White
Write-Host ""
