...
/**
 * Unit tests for {@link MusicMode} command DTO.
 *
...
class MusicModeTest {
    ...
    @Test
    @DisplayName("MusicMode: Should set and get music mode properties")
    void testMusicModeSetGet() {
        MusicMode cmd = new MusicMode();
        cmd.setSwitch("on");
        cmd.setMode(2);
        ...
        assertEquals(75, cmd.getBrightness());
