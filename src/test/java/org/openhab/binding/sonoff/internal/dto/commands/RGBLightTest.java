...
/**
 * Unit tests for {@link RGBLight} command DTO.
 *
...
class RGBLightTest {
    ...
    @Test
    @DisplayName("RGBLight: Should set and get RGB values")
    void testRGBLightSetGet() {
        RGBLight cmd = new RGBLight();
        cmd.setColorR(255);
        cmd.setColorG(128);
        cmd.setColorB(0);
